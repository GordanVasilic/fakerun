...
<div className="absolute bottom-4 left-4 flex flex-row space-x-2 z-[1000]">
      ...
      <span>Clear Map</span>
       ...
       <div className="absolute top-4 left-4 z-[1000] w-80">
        <div className="bg-white bg-opacity-90 rounded-lg shadow-lg px-4 py-3 mb-4">
          <h1 className="text-2xl font-bold text-gray-900 whitespace-nowrap">Create Your Custom Route</h1>
